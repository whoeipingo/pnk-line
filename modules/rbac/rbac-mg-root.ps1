...
az role assignment create --assignee-object-id ((az ad group show --group IAM-UM-AZ-Root_Admin_Access-Owner-P | ConvertFrom-Json).objectId) --assignee-principal-type group --role "Reader" --scope "/"
